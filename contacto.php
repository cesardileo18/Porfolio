...
if ($_POST) { /* es postback */
  ...
  if ($nombre != "" && $correo != "") {
    ...
    $mail->IsSMTP();
    $mail->SMTPAuth = true;
    $mail->Host = "mail.cesardileonardo.com.ar"; // SMTP a utilizar
    $mail->Username = "info@cesardileonardo.com.ar"; // Correo completo a utilizar
    $mail->Password = "1719Anadi";
    $mail->Port = 25;
    $mail->SMTPAutoTLS = false;
    $mail->From = "info@cesardileonardo.com.ar"; //Desde la cuenta donde enviamos
    ...
    $mail->addAddress("info@cesardileonardo.com.ar");
  ...
  <header>
    ...
    <nav>
      <ul>
        ...
        <li><a href="sobremi.php"><span class="icon-user-tie"></span>Sobre mi</a></li>
        <li><a href="proyectos.php"><span class="icon-briefcase"></span>Proyectos</a></li>
